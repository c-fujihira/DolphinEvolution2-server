...
import open.dolphin.converter.CodeNamePackConverter;
import open.dolphin.converter.DiseaseListConverter;
import open.dolphin.converter.DragInteractionListConverter;
import open.dolphin.converter.ModuleListConverter;
import open.dolphin.converter.OrcaInputCdListConverter;
import open.dolphin.converter.RegisteredDiagnosisListConverter;
import open.dolphin.converter.TensuListConverter;
...
//                rdm.setCategoryCodeSys("MML0012");
    ...
    //masuda^   ResultSetからRegisteredDiagnosisModelを
    private RegisteredDiagnosisModel getRegisteredDiagnosisModel(List<String> values) {
        ...
        debug(rd.getDiagnosisCode());
        debug(rd.getDiagnosis());
        debug(rd.getCategory());
        debug(rd.getOutcome());
        debug(rd.getStartDate());
        debug(rd.getEndDate());
        debug(rd.getStatus());
