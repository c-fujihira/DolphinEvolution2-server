...
//        try {
//            result = (PatientVisitModel) em.createQuery(sql)
//                    .setParameter("fid", fid)
...
//        long modelCount = (Long) em.createQuery("select count(m) " + fromSql)
//                .setParameter("fPk", fPk)
...
//
//        try {
//            long facilityPk = (Long) em.createQuery("select f.id from FacilityModel f where f.facilityId = :fid")
//                    .setParameter("fid", fid)
//                    .getSingleResult();
//            return facilityPk;
//        } catch (NoResultException e) {
...
//
//        List<PatientVisitModel> pvtList = (List<PatientVisitModel>) em.createQuery(sqlPvt)
//                .setParameter("fid", fid)
...
//        long modelCount = (Long) em.createQuery(sql2)
//                .setParameter("fid", fid)
//                .getSingleResult();
//        // 結果を返す
...
//            try {
//                ETensuModel1 exist = (ETensuModel1) em.createQuery(sql1)
...
//                try {
//                    SanteiHistoryModel exist = (SanteiHistoryModel) em.createQuery(sql4)
...
//
//            list = (List<SanteiHistoryModel>) em.createQuery(sql)
//                    .setParameter("kId", karteId)
//                    .setParameter("fromDate", fromDate)
//                    .setParameter("toDate", toDate)
//                    .getResultList();
...
//            try {
//                // 既存のpropertyを取得する
//                UserPropertyModel exist = (UserPropertyModel) em.createQuery(sql1)
...
//
//        List<UserPropertyModel> list = (List<UserPropertyModel>) em.createQuery(sql)
//                .setParameter("fid", fid)
...
//        try {
//            UserPropertyModel model = (UserPropertyModel) em.createQuery("from UserPropertyModel u where u.key = :key and u.value = :value")
...
//
//        long c = (Long) em.createQuery("select count(*) from UserPropertyModel u where u.key = :key and u.value = :value")
...
//
//        // 既存の入院モデルを取得する
//        List<AdmissionModel> list = (List<AdmissionModel>) em.createQuery(sql)
...
//                List<DocumentModel> docList = (List<DocumentModel>) em.createQuery("from DocumentModel d where d.admission.id = :id")
//                        .setParameter("id", id)
//                        .getResultList();
...
//
//        List<DocumentModel> documents = (List<DocumentModel>) em.createQuery(sql)
//                .setParameter("fromDate", fromDate)
